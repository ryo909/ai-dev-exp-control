...
## よく効いた competitor patterns
- 冒頭で主張や問題設定を先に提示する構成が多い
- CTAは購読・続きを読む・議論参加など次行動を明示する形式が中心
...
## portfolio hotspots
- missing or weak live demo links

## growth hotspots
- なし

## strategy signals
- primary_modes: clarity-first utility, showcase one + safe six, portfolio-visible impact
- avoidance_modes: over-complex novelty bets, 模倣色の強い competitor hook, demo導線が弱いままの公開

## evidence/reality hotspots
- evidence: なし
- reality: なし
...
- showcase slot: 5 / 見た目と差分訴求が強い1本にする
...
- reports/growth/growth_brief_2026-03-08.json
- reports/strategy/strategy_brief_2026-03-08.json
- reports/evidence/evidence_2026-03-08.json
- reports/reality/reality_gate_2026-03-08.json
- reports/launch/launch_pack_2026-03-08.json
- exports/launch/launch_export_2026-03-08.json
- reports/feedback/post_launch_feedback_2026-03-08.json
- reports/healthcheck/healthcheck_2026-03-08.json
- memory/MEMORY.md
- shared-context/FEEDBACK-LOG.md
- shared-context/SOURCES.md
