# Healthcheck (2026-03-07)

## 今週の healthcheck 総評
- overall_status: attention
- repo_cleanliness: dirty
- manual_attention_count: 5

## 実行前に見ておくべき warning
- repo_status: dirty_count=7; untracked_count=20; working tree has tracked modifications
- artifact_freshness: missing artifact: strategy; missing artifact: growth; missing artifact: portfolio
